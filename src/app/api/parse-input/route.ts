...
const CITY_NORMALIZATION: Record<string, string> = {
  ...
  'grant park': 'Atlanta', 'kirkwood': 'Atlanta', 'edgewood': 'Atlanta',
  ...
  'richmond heights': 'St Louis', 'university city': 'St Louis', 'ladue': 'St Louis',
  ...
  'st charles': 'St Louis', 'st charles mo': 'St Louis', 'st peters': 'St Louis',
  ...
  'garfield heights': 'Cleveland', 'maple heights': 'Cleveland', 'bedford': 'Cleveland',
