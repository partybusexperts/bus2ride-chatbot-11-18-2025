...
const CITY_NORMALIZATION: Record<string, string> = {
  ...
  'glen ellyn': 'Chicago', 'glen ellyn il': 'Chicago', 'wheaton': 'Chicago', 
  ...
  'naperville il': 'Chicago', 'oswego': 'Chicago', 'plainfield': 'Chicago',
  ...
  'douglasville': 'Atlanta', 'woodstock': 'Atlanta', 'canton ga': 'Atlanta',
  // Las Vegas metro
